...
def prior(num_predictors: int=1, pred_effect_scale=jnp.ones(1), Tavg_dof_mean=None,
...
def precip(num_predictors: int=1, pred_effect_scale=jnp.ones(1), freqs=[1/365.25], order=1, **kwargs):
    ...
    precip_mean_all_effects = jnp.concat([precip_mean_seasonal_effects, precip_mean_lag_effects, precip_mean_Tavg_effects, precip_mean_pred_effects], axis=-1)
    ...
    precip_shape_all_effects = jnp.concat([precip_shape_seasonal_effects, precip_shape_lag_effects, precip_shape_pred_effects], axis=-1)
